...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: de ? "/de/datenschutz" : "/privacy",
      ...
      >
        ...
        <section id="hosting">
          ...
          <p>
            ...
            Das primäre Datenbankprojekt ist für die Region Frankfurt konfiguriert. Dies bedeutet jedoch nicht automatisch,
            dass sämtliche Verarbeitung durch Anbieter und Unterauftragsverarbeiter ausschließlich im EWR stattfindet.
          </p>
          <p>
        ...
        <section id="cookies">
          ...
          <p>
            Die aktuelle Anwendung lädt bewusst keine Drittanbieter-Werbe- oder Analyse-Skripte. Für notwendige Funktionen
            können technisch erforderliche Browser-Speichermechanismen, Sitzungsinformationen und lokale Einstellungen genutzt werden.
          </p>
          <p>
            Nicht erforderliche Analyse-, Marketing- oder Tracking-Technologien werden erst nach vorheriger Einwilligung aktiviert,
            falls solche Dienste künftig eingeführt werden. Die Cookie-/Datenschutzeinstellungen können über den Footer erneut geöffnet werden.
          </p>
        ...
        <section id="bewerbungen">
          ...
          <p>
            Bei einer Bewerbung können insbesondere Name, E-Mail-Adresse, Telefonnummer, Wohn-/Standortangaben, berufliche Rolle,
            Unternehmen/Venture, Website, Entwicklungsphase, Geschäftsmodell, KI-/Digitalisierungsinteressen, Motivation,
            Ziele sowie weitere freiwillig eingegebene Angaben verarbeitet werden.
          </p>
          <h3>Zwecke</h3>
          <ul>
        ...
        <section id="empfaenger">
          ...
          <p>
            ...
            Aktuell relevante technische Anbieter sind insbesondere <strong>{privacyInfrastructure.hosting}</strong> (Hosting/Deployment)
            und <strong>{privacyInfrastructure.database}</strong> (Datenbank).
          </p>
          <p>
    ...
    >
      ...
      <section id="hosting">
        ...
        <p>
          ...
          The primary database project is configured for Frankfurt. This alone does not mean every provider or subprocessor activity occurs exclusively in the EEA.
        </p>
        <p>
      ...
      <section id="cookies">
        ...
        <p>
          The current application intentionally does not load third-party advertising or analytics scripts.
          Strictly necessary browser storage, session functionality and local preferences may be used to provide requested functionality and security.
        </p>
        <p>
          If optional analytics, marketing or tracking technologies are introduced later, they will remain disabled until any legally required consent is obtained.
          Privacy/cookie settings can be reopened from the site footer.
        </p>
        <p className={styles["legal-note"]}>
      ...
      <section id="applications">
        ...
        <p>
          Application data may include name, email, phone, city/country, role, venture/company details, website, venture stage,
          business model, AI/digitalisation interests, motivation, goals and other information voluntarily submitted by the applicant.
        </p>
        <h3>Purposes</h3>
        <ul>
      ...
      <section id="recipients">
        ...
        <p>
          ...
          Current infrastructure providers include <strong>{privacyInfrastructure.hosting}</strong> (hosting/deployment)
          and <strong>{privacyInfrastructure.database}</strong> (database).
        </p>
        <p>
